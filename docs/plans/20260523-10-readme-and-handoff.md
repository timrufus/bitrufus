...
- [ ] Run the app with at least two active downloads visible, capture a screenshot at 1x resolution, and place it at `docs/screenshots/main-window.png`.
- [ ] Embed it in the README under a "Screenshots" section.
